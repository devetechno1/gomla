...
class Variation {
  ...
  Variation({this.type, this.price, this.stock,this.maxVariations,this.minVariations});

  Variation.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    price = json['price']?.toDouble();
    stock = int.parse(json['stock'] != null ? json['stock'].toString() : '0');
    maxVariations = int.parse(json['maxqty'] != null ? json['maxqty'].toString() : '0');
    minVariations=int.parse(json['miniqty'] != null ? json['miniqty'].toString() : '0');
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['price'] = price;
    data['stock'] = stock;
    data['maxqty'] = maxVariations;
    data['miniqty'] = minVariations;
    return data;
  }
}
