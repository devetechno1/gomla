...
class ItemDetailsScreen extends StatefulWidget {
  ...
  const ItemDetailsScreen({super.key, required this.item, required this.inStorePage, this.variations});
                              ...
                              return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                GridView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    // print("var mohsen fffuyffyy=================>  ${itemController.item!.variations![i].maxVariations}");
                                    return InkWell(
                                      onTap: () {
                                        // print("var mohsen=================>  ${itemController.item!.variations![i].maxVariations}");
                                    ...
                                    child: Row(children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: cartController.isLoading ? null : () {
                                          ...
                                          } else if (itemController.quantity!  < maxqqq! ){
                                            print("Max Variations=================>  ${maxqqq!}"); //maximum quantity
                                            print("var itemController.quantityy=================>  ${itemController.quantity}"); //quantity
                                            itemController.setQuantity(true, stock, itemController.item!.quantityLimit);

                                          } else if( itemController.quantity!  >= itemController.item!.stock!){
...
class QuantityButton extends StatelessWidget {
  ...
  const QuantityButton({super.key,
    ...
    this.quantityLimit,
    required this.cartController,  this.variations,
  });
      ...
      onTap: cartController.isLoading ? null : () {
        if(isExistInCart) {
          if (!isIncrement && quantity! > 1) {
            ...
            // if(isIncrement && quantity! > variations!.maxVariations!) {
            //   Get.find<ItemController>().setQuantity(
            //       false, stock, quantityLimit);
            // }else{
            //   showCustomSnackBar("message");
            //   print("${variations!.maxVariations!}!");
            // }
          }
        } else {
          if (!isIncrement && quantity! > 1) {
