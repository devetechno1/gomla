...
class AddressCheckBoxWidget extends StatelessWidget {
  final bool isAddress;

  const AddressCheckBoxWidget({super.key, this.isAddress = false});
  ...
  Widget build(BuildContext context) {
    ...
    //   }) : const SizedBox(),
    //
    //   const SizedBox() : Text( '* ', style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
    //
    //   Flexible(
    //     child: RichText(
