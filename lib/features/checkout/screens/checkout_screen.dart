...
class CheckoutScreen extends StatefulWidget {
  ...
  const CheckoutScreen({super.key, required this.fromCart, required this.cartList, required this.storeId, this.variation});
    ...
    return Container(
      ...
      child: SafeArea(
        child: CustomButton(
          ...
          }else if( checkoutController.streetNumberController.text==""&& checkoutController.houseController.text==""&& checkoutController.floorController.text==""&& checkoutController.orderType != 'take_away') {
            showCustomSnackBar('please_complete_your_address'.tr);
          }else if( checkoutController.streetNumberController.text==""&& checkoutController.orderType != 'take_away') {
            showCustomSnackBar('please_enter_your_street_number'.tr);
          }else if( checkoutController.houseController.text=="" && checkoutController.orderType != 'take_away') {
            showCustomSnackBar('please_enter_your_house'.tr);
          }else if( checkoutController.floorController.text =="" && checkoutController.orderType != 'take_away') {
            showCustomSnackBar('please_enter_your_floor'.tr);
          ...
          } else if(_cartList!.length < checkoutController.store!.minimumOrderItems! && widget.storeId == null) {
            showCustomSnackBar('${'minimum_order_items_is'.tr} ${checkoutController.store!.minimumOrderItems}');
            print("itemssss${_cartList!.length}");
