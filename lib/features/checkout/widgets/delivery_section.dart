                    ...
                    itemBuilder: (context)  => List.generate(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          if(checkoutController.streetNumberController.text == "" || checkoutController.floorController.text==""||checkoutController.houseController.text=='') {

                            showCustomSnackBar("Please Complete Your Address!");
                          }else {
