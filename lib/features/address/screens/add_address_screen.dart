...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  void _onSaveOrUpdateButtonPressed(LocationController locationController) async {
    ...
    if(_streetNumberController.text =='' || _floorController.text =='' || _addressController.text ==''
        || _contactPersonNameController.text ==''|| _houseController.text =='' || _contactPersonNumberController.text == '') {
