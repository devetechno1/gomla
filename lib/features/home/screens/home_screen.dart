...
import '../../call/call_bottom_sheet.dart';
    ...
    return GetBuilder<SplashController>(builder: (splashController) {
      ...
      return GetBuilder<HomeController>(builder: (homeController) {
        return Scaffold(
                        ...
                        InkWell(
                          child: GetBuilder<NotificationController>(builder: (notificationController) {
                            return Stack(children: [
                              Icon(Icons.wifi_calling_3_sharp, size: 25, color: Theme.of(context).textTheme.bodyLarge!.color),
                          ...
                          onTap: () {
                            showModalBottomSheet(
                              ...
                              builder: (con) => const CallBottomSheetWidget(),
                            );
                          },
                  ...
                  SliverToBoxAdapter(
                    child: Center(child: SizedBox(
                      ...
                      child: !showMobileModule ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(Get
          ...
          floatingActionButton: AuthHelper.isLoggedIn() && homeController.cashBackOfferList != null && homeController.cashBackOfferList!.isNotEmpty ? Padding(
