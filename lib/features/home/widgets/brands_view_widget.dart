        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            return Container(
              ...
              child:  InkWell(
                onTap: () {
                  Get.toNamed(RouteHelper.getBrandsItemScreen(brandsController.brandList![index].id!,
                      brandsController.brandList![index].name!));
                  print("vvvvv====${Get.find<SplashController>().configModel!.baseUrls!.brandImageUrl}/${brandsController.brandList![index].image}");
                },
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                  child: CustomImage(
