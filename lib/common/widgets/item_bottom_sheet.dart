            ...
            if(_newVariation) {
              ...
              for (Variation variations in widget.item!.variations!) {
                if (variations.type == variationType) {
                  ...
                  maxqqq=variations.maxVariations;
                  break;
                }
              }
            }
                              ...
                              Row(children: [
                                ...
                                QuantityButton(
                                  onTap: () {
                                    ...
                                    if(itemController.quantity! +1 <= maxqqq! && itemController.quantity! < itemController.item!.stock!) {
                                      itemController.setQuantity(true, stock, widget.item!.quantityLimit, getxSnackBar: true);
                                    }else if(itemController.quantity! >= stock!){
                                      ...
                                      showCustomSnackBar('out_of_stock'.tr, getXSnackBar: true);
                                       ...
                                       showCustomSnackBar("Maximum order is ${maxqqq}", getXSnackBar: true);
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
             print("mohsen =================>  ${itemController.item!.variations![index].maxVariations!}");
              return InkWell(
                onTap: () {
                  if (!itemController.addOnActiveList[index]) {
                  ...
                  } else if(itemController.addOnQtyList[index]! <= itemController.item!.variations![index].maxVariations!){
