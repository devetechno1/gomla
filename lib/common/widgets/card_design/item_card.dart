                ...
                child: Stack(
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: isPopularItem ? Dimensions.paddingSizeExtraSmall : 0,
                        left: isPopularItem ? Dimensions.paddingSizeExtraSmall : 0, right: isPopularItem ? Dimensions.paddingSizeExtraSmall : 0),
                    child: ClipRRect(
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: Stack(clipBehavior: Clip.none, children: [
                    ...
                    Column(
                      crossAxisAlignment: isPopularItem ? CrossAxisAlignment.center : CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ///name of store
                      (isFood || isShop) ? Text(item.storeName ?? '',
                      ...
                      (isFood || isShop) ? Flexible(
                        child: Text(
                          ...
                          : Row(mainAxisAlignment: isPopularItem ? MainAxisAlignment.center : MainAxisAlignment.start,
                          children: [
                      ...
                      /// rating section
                      (isFood || isShop) ? Row(mainAxisAlignment: isPopularItem ?
                      MainAxisAlignment.center : MainAxisAlignment.start, children: [
                        Icon(Icons.star, size: 14, color: Theme.of(context).primaryColor),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                      ...
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          ...
                          isShop ? CartCountView(
                            ...
                            child: Container(
                              ...
                              child: Icon(isPopularItemCart
                                  ? Icons.add_shopping_cart : Icons.add, color: Theme.of(context).cardColor,
                                  size: 20),
                            ),
                          ) : const SizedBox(),
